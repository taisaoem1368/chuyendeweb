                ...
                <div id="carousel-area" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item active">
                            <img src="{{url('/temp/theme-assets/images/carousel/08.jpg')}}" class="d-block w-100" alt="First slide">
                        </div>
                        <div class="carousel-item">
                            <img src="{{url('/temp/theme-assets/images/carousel/03.jpg')}}" class="d-block w-100" alt="Second slide">
                        </div>
                        <div class="carousel-item">
                            <img src="{{url('/temp/theme-assets/images/carousel/01.jpg')}}" class="d-block w-100" alt="Third slide">
                        </div>
                    </div>
